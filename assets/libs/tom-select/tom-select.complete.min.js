  ...
  class de extends (function (e) {
    return e.plugins = {}, class extends e {
      ...
      constructor(e, t) {
        ...
        e && (t.setTextboxValue(), "single" === t.settings.mode && t.items.length && t.inputState()), t.isOpen = !1, Q(t.focus_node, { "aria-expanded": "false" }), q(t.dropdown, { display: "block" }), t.settings.hideSelected && t.clearActiveOption(), t.refreshState(), i && t.trigger("dropdown_close", t.dropdown)
      } positionDropdown() {
